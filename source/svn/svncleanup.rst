...
This will open the cleanup window. You want to make sure **Break locks** and **Clean up working copy status** is selected, and it can be nice to **Refresh shell overlays** too.
